...
extern "C" {
	...
	int iHxPbocHighInitTrans(char *pszDateTime, unsigned long ulAtc, unsigned char ucTransType, unsigned char *pszAmount, char *pszField55, char *pszPan, int *piPanSeqNo, char *pszTrack2, char *pszExtInfo);
